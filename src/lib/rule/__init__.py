...
class RuleMain:
    def __init__(self, sessionTag):
        self._handlers = []
        self._sessionTag = _required(sessionTag, 'sessionTag')
    ...
    def _session_name(self):
        prefix = 'Remediate-'
        if self._sessionTag.startswith(prefix): return self._sessionTag
        return prefix + self._sessionTag
